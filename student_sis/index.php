...
$count_res = mysqli_query($connection, "SELECT COUNT(*) as total FROM tblstudent");
$total_students = $count_res ? mysqli_fetch_assoc($count_res)['total'] : 0;
$prog_res = mysqli_query($connection, "SELECT COUNT(DISTINCT program) as total FROM tblstudent");
